...
<form action="<?php echo base_url()?>Welcome/SearchResults" method="POST">

<input type="text" onkeypress="<?php echo base_url()?>/Welcome/SearchResults" name="search" placeholder="Search Books and Authors">
...
<form action="<?php echo base_url()?>/Welcome/Category" method="POST">
...
<a href="<?php echo base_url() ?>Welcome/getCover?id= <?php echo $record->Book_ID; ?>"><img alt="book" style="width:150px;  height:210px; padding-left:10px;padding-top:10px" src="<?php echo base_url()?>/assets/Images/<?php echo $record->Image; ?>"></a>
